...
Animal.prototype.setSoundOfAnimal = function (voice) {
    voice === null ? this.sound = "Dont know ((" : this.sound = `${voice} ~~ ${voice} ~~ ${voice}`
};
...
Mammals.prototype.showFoodToString = function(){
    let str = "";
    for(let i in this.food){str += this.food[i]+ " "};
    return str
};
...
// Class Birds extends Class Animal
// function Birds(name, voice, speed, sex, ...food) {
//     Animal.call(this, name, voice);
//     this.speed = speed;
//     this.legs = 4;
//
